...
export class Pair {
  ...
  public swapName: SWAP_NAME

  private readonly tokenAmounts: [TokenAmount, TokenAmount]

  public static getAddress(tokenA: Token, tokenB: Token, swapName: SWAP_NAME): string {
  ...
  public constructor(tokenAmountA: TokenAmount, tokenAmountB: TokenAmount, swapName: SWAP_NAME = SWAP_NAME.pancakeswap) {
    ...
    this.liquidityToken = new Token(
      ...
      Pair.getAddress(tokenAmounts[0].token, tokenAmounts[1].token, swapName),
      18,
      'Cake-LP',
      'Pancake LPs'
    )
  ...
  public getOutputAmount(inputAmount: TokenAmount): [TokenAmount, Pair] {
    ...
    return [outputAmount, new Pair(inputReserve.add(inputAmount), outputReserve.subtract(outputAmount), this.swapName)]
  }
  ...
  public getInputAmount(outputAmount: TokenAmount): [TokenAmount, Pair] {
    ...
    return [inputAmount, new Pair(inputReserve.add(inputAmount), outputReserve.subtract(outputAmount), this.swapName)]
  }
